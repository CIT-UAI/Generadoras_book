...
<br> Para facilitar el entendimiento el proceso de cálculo del AHP se utiliza como ejemplo los pasos realizados para analizar las plantas de generación de energía Solar Fotovoltáica para región de estudio.
...
![Categorización de resultados](images/intervalos.png){#fig-q4 fig-align="center" width="200"} <!-- Espacialmente los resultado se presentan de la siguiente forma -->

<!-- ![Actualizar esta imagen](images/image-741593790.png){fig-align="center" width="500"} -->
...
![Actualizar esta imagen](images/dashboard.png){fig-align="center" width="800"}
